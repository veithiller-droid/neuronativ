...
export const PROFILE_TEXTS = {
  ...
  ui: {
    ...
    disqualification: {
      ...
      adhd: {
        ...
        criteria:
          "Symptombeginn wurde für Aufmerksamkeit/Executive nach dem 12. Lebensjahr (12+) angegeben. DSM-5 verlangt für ADHS einen Symptombeginn vor dem 12. Lebensjahr.",
        meaning:
          "Die hohen Werte im ADHS-Cluster zeigen ADHS-ähnliche Symptome. Diese können jedoch andere Ursachen haben: chronischer Stress, Burnout, Depression, Trauma, hormonelle Faktoren (z.B. Schilddrüse), Medikamentennebenwirkungen, oder Schlafstörungen.",
      ...
      autism_criteria_a: {
        ...
        criteria_template:
          "DSM-5 Kriterium A nicht erfüllt: Nicht alle 3 Bereiche der sozialen Kommunikation wurden bestätigt ({count}/3 Bereiche).",
        meaning:
          "Die Werte im Autismus-Cluster zeigen autismus-ähnliche Züge. Kriterium A verlangt jedoch, dass alle 3 Bereiche (soziale Reziprozität, nonverbale Kommunikation, Beziehungsgestaltung) zutreffen. Mögliche alternative Erklärungen: soziale Angststörung, ADHS mit sozialen Schwierigkeiten, Trauma-Folgen, oder einzelne autistische Traits ohne Vollbild.",
        next_steps:
          "Fachliche Abklärung kann helfen, die Ursachen zu differenzieren und passende Unterstützung zu finden.",
      },

      autism_criteria_b: {
        title: "Autismus-Profil erfüllt nicht die diagnostischen Kriterien",
        criteria_template:
          "DSM-5 Kriterium B nicht erfüllt: Weniger als 2 der 4 RRB-Bereiche (repetitive Verhaltensweisen, Interessen, sensorische Besonderheiten) wurden bestätigt ({count}/4 Bereiche).",
        meaning:
          "Die Werte im Autismus-Cluster zeigen autismus-ähnliche Züge. Kriterium B verlangt jedoch mindestens 2 von 4 RRB-Bereichen. Mögliche alternative Erklärungen: ADHS mit Hyperfokus, Zwangsstörung, spezifische sensorische Verarbeitungsstörung, oder einzelne autistische Traits ohne Vollbild.",
        next_steps:
          "Fachliche Abklärung kann helfen, die Ursachen zu differenzieren und passende Unterstützung zu finden.",
      },
      ...
      audhd: {
        ...
        meaning:
          "Die Werte zeigen eine Überlappung von ADHS- und Autismus-ähnlichen Zügen. Für eine AuDHD-Konstellation müssen jedoch beide Diagnosen unabhängig die jeweiligen Kriterien erfüllen.",
        next_steps:
          "Fachliche Abklärung kann helfen zu klären, welche Dynamik hier dominiert und welche Unterstützung am besten passt.",
      },
    ...
    discrepancy: {
      section_title:
        "Kontext-Hinweise zur Einordnung (Belastung, Maskierung, Dynamik). Sie erklären, welche Faktoren die Ausprägungen im Alltag aktuell prägen.",
      icon: "⚠️",
      flag_labels: {
  ...
  clusters: {
    ...
    compensation: {
      ...
      scales_included: ["Maskierung & Anpassung", "Überlastung & Erholung"],
      what_high_means:
  ...
  reasoning: {
    ...
    hyperfocus_basis: {
  title: "Hyperfokus in der Einordnung",
  include_note: "Hyperfokus wird als Zusatzsignal genutzt: als erklärender Faktor und – bei knapper Lage – als Tie-Breaker zwischen ADHS-nah und autismus-nah.",
  line_adhd_like: "Hyperfokus-Tendenz: eher ADHS-nah (interessengetrieben/wechselnd, Aufhören/Wechseln schwer).",
  line_autism_like: "Hyperfokus-Tendenz: eher autismus-nah (themenstabil, struktur-/systematisch gekoppelt).",
  line_mixed: "Hyperfokus-Tendenz: gemischt (kein eindeutiger Ausschlag).",
  line_unknown: "Hyperfokus-Tendenz: unklar (Zusatzdaten fehlen/unklar)."
},

hyperfocus_badge: {
    title: "Hyperfokus-Signal",
    badge_adhd_like: "Hyperfokus eher ADHS-nah",
    badge_autism_like: "Hyperfokus eher autismus-nah",
    badge_mixed: "Hyperfokus gemischt",
    badge_unknown: "Hyperfokus unklar",
    note: "Wird als Zusatzsignal genutzt: erklärend und bei knapper Lage als Tie-Breaker."
  },
  
foundation_hyperfocus_lines: {
  adhd_like: "Zusatzsignal: Hyperfokus-Muster spricht eher für interessengetriebene Vertiefung (ADHS-nah).",
  autism_like: "Zusatzsignal: Hyperfokus-Muster spricht eher für langfristig stabile/systematische Vertiefung (autismus-nah).",
  mixed: "Zusatzsignal: Hyperfokus-Muster ist gemischt und wurde nur erklärend genutzt.",
  unknown: "Zusatzsignal: Hyperfokus-Muster konnte nicht sicher eingeordnet werden."
},
    ...
    cluster_sentences: {
      high: {
        ...
        autism:
          "Autismus-Cluster {autism}%: Viele Hinweise auf starke Reizverarbeitung, Strukturbedarf und eher analytische soziale Verarbeitung.",
        emotional:
          "Emotionale Verarbeitung {emotional}%: Emotionale Dynamik steht in Ihren Antworten deutlich im Vordergrund.",
        compensation:
          "Kompensation & Belastung {compensation}%: Maskierung/Überlastung spielen in Ihren Antworten deutlich eine Rolle.",
      },
      mid: {
        adhd: "ADHS-Cluster {adhd}%: Einige ADHS-nahe Aspekte sind erkennbar, aber nicht durchgängig dominant.",
        autism:
          "Autismus-Cluster {autism}%: Einige autismus-nahe Aspekte sind erkennbar, aber nicht durchgängig dominant.",
        emotional:
          "Emotionale Verarbeitung {emotional}%: Emotionale Aspekte sind spürbar, aber nicht zentral.",
        compensation:
          "Kompensation & Belastung {compensation}%: Anpassung/Belastung sind spürbar, aber nicht zentral.",
      },
      low: {
        adhd: "ADHS-Cluster {adhd}%: ADHS-nahe Muster stehen in Ihren Antworten nicht im Vordergrund.",
        autism:
          "Autismus-Cluster {autism}%: Autismus-nahe Muster stehen in Ihren Antworten nicht im Vordergrund.",
        emotional:
          "Emotionale Verarbeitung {emotional}%: Emotionale Dynamik steht in Ihren Antworten nicht im Vordergrund.",
        compensation:
          "Kompensation & Belastung {compensation}%: Maskierungs-/Überlastungsfaktoren stehen in Ihren Antworten nicht im Vordergrund.",
      },
    },
  ...
  /* =====================================================
     8) PATTERNS (Kurznotizen – stärkend, lösungsorientiert)
  ===================================================== */
  patterns: {
    templates: {
      structure_vs_executive:
        "Sie profitieren spürbar von Struktur – gleichzeitig kosten Start, Wechsel und Dranbleiben unverhältnismäßig viel Energie. Das ist kein Widerspruch, sondern ein Muster: Mit kleinen, festen Einstiegsschritten wird Umsetzung deutlich leichter.",

      social_plus_masking:
        "Soziale Situationen gelingen Ihnen oft – aber mit hohem inneren Aufwand (Masking). Das spricht für starke Anpassungsfähigkeit; nachhaltiger wird es, wenn Erholung und „Ich darf so sein“-Momente bewusst eingeplant sind.",

      sensory_plus_overload:
        "Reize werden intensiv verarbeitet und die Erholung ist begrenzt. Das ist häufig eine feine Wahrnehmung mit hoher Bandbreite – Reizmanagement (Licht, Lärm, Tempo) wirkt hier direkt wie ein Energie-Booster.",

      adhd_plus_emotional:
        "Aufmerksamkeit/Handlungsdruck und emotionale Dynamik hängen bei Ihnen eng zusammen. Das kann Intensität und Kreativität stärken – und wird stabiler, wenn Sie früh kleine Regler nutzen (Pause, Körpercheck, klare nächste Schritte).",

      audhd_conflict:
        "Strukturbedarf und Wechsel/Impuls wirken gleichzeitig stark. Das kann sich innen „gegensätzlich“ anfühlen, ist aber ein konsistentes Mischmuster: Wenn Regeln flexibel genug sind, entsteht daraus oft echte Selbstwirksamkeit.",

      hyperfocus_plus_overload:
        "Vertiefung ist eine Ihrer Superkräfte – und kann Ressourcen schnell aufbrauchen, wenn Erholung zu spät kommt. Mit klaren Stopps und geplanten Pausen bleibt die Stärke nutzbar, ohne dass der Preis zu hoch wird.",

        // --- Hyperfokus-Tendenz (ADHS vs Autismus) -----------------
hf_data_present:
  "Hyperfokus wurde mit Zusatzfragen vertieft und in die Einordnung einbezogen.",

hf_adhd_like:
  "Hyperfokus wirkt eher interessengetrieben und wechselanfällig; das Aufhören/Wechseln ist (teils deutlich) schwer. Dieses Muster passt häufiger zu ADHS-nahen Mechanismen.",

hf_autism_like:
  "Hyperfokus wirkt eher themenstabil und mit Struktur/Regeln/Systematik gekoppelt. Dieses Muster passt häufiger zu autismus-nahen Mechanismen.",

hf_mixed:
  "Hyperfokus zeigt gemischte Merkmale (interessengetrieben + teils strukturiert), ohne klare Zuordnung zu einer Seite.",

hf_unknown:
  "Hyperfokus-Zusatzfragen sind unklar oder fehlen; keine belastbare Einordnung der Tendenz möglich.",

hf_tiebreak_used:
  "Hyperfokus wurde als Tie-Breaker genutzt, weil ADHS-Cluster und Autismus-Cluster nah beieinander liegen.",
// ------------------------------------------------------------


      hyperfocus_exit_cost:
        "Wenn Interesse da ist, entsteht starke Vertiefung – der Ausstieg (Stopp/Wechsel/Grundbedürfnisse) ist dann oft der schwerste Teil. Eine einfache Stopp-Regel + Reminder schützt Ihre Energie, ohne den Flow zu zerstören.",

      mixed_onset_timing:
        "Die Startzeitpunkte unterscheiden sich je Bereich. Das passt gut zu einem Bild aus Basis-Traits plus späteren Overlays – beides darf gleichzeitig wahr sein, ohne dass Ihre Erfahrungen „weniger echt“ werden.",

      late_onset_overload_overlay:
        "Ein Teil der Überlastungsdynamik wirkt eher später entstanden. Das passt zu einem „Overlay“ durch Lebensphase/Anforderungen: Entlastung und Rhythmus machen hier oft schnell einen spürbaren Unterschied.",

      late_onset_masking_overlay:
        "Masking/Anpassungsaufwand wirkt eher später stärker geworden. Das spricht häufig für erlernte Strategien unter Druck – hilfreich ist, bewusst zwischen „funktionieren“ und „auftanken“ zu unterscheiden.",

      late_onset_emotional_overlay:
        "Die emotionale Dynamik wirkt eher später stärker geworden. Das passt zu einem Overlay durch Stress/Last: Stabilität wird oft leichter, wenn Sie Frühmarker früher abfangen und Regeneration planbarer machen.",

      masking_exhaustion:
        "Anpassung kostet Sie spürbar Kraft. Das zeigt nicht „Schwäche“, sondern wie viel Sie leisten – Entlastung entsteht oft durch kleine Erlaubnisse: weniger erklären, weniger perfekt, mehr Erholung nach Kontakt.",

      task_initiation_wall:
        "Der Einstieg fühlt sich manchmal wie eine „Wand“ an, obwohl Sie wissen, was zu tun wäre. Das ist ein typisches Energie-/Startproblem: 2-Minuten-Start + sichtbarer erster Schritt bringt Ihr System oft ins Rollen.",

      shutdown_cognitive:
        "Unter Überreizung kann Denken/Sprechen kurzfristig schwerer werden. Ihr System schützt sich dann – am besten helfen klare Reduktion (Reize raus) und ein einfacher Rückweg (Wasser, Ruhe, kurzer Reset).",

      emotion_switch_rapid:
        "Emotionen können schnell kippen, besonders unter Druck. Das ist oft hohe Sensitivität – stabiler wird es, wenn Sie früh Signale erkennen und mit kurzen Unterbrechungen arbeiten, statt erst im Maximum zu reagieren.",

      alexithymia_words_hard:
        "Gefühle sind nicht immer leicht in Worte zu fassen. Das ist häufig eine andere Art von Innenwahrnehmung – mit Zeit, Abstand und Körperankern (Ort, Spannung, Wärme) wird es meist deutlich leichter.",

      complex_emotional_pattern:
        "Emotionswahrnehmung und Emotionsregulation zeigen gemeinsam ein starkes Muster. Das kann sich subjektiv widersprüchlich anfühlen (viel fühlen, schwer benennen) – mit einfachen Körpermarkern und kurzen Regler-Routinen wird es oft deutlich klarer.",

      stress_overlay:
        "Aktuelle Belastung kann Traits überlagern. Wenn Systemlast sinkt, wird die Einordnung oft klarer und Strategien greifen leichter.",

      high_masking:
        "Deutliche Kompensation (Masking) ist erkennbar. Das kann Stabilität ermöglichen – und braucht bewusst eingeplante Erholung, damit es nachhaltig bleibt.",

      audhd_specific:
        "Ein Interaktionsmuster aus Strukturbedarf, Interesse-Vertiefung und Wechsel-Kosten ist erkennbar. Wenn Regeln flexibel sind und Übergänge geplant werden, wird daraus oft ein sehr tragfähiger Alltag.",

      traits_only:
        "Es zeigen sich einzelne Traits, ohne dass ein Bereich klar dominiert. Das ist ein häufiges Bild – gezielte kleine Anpassungen können trotzdem spürbar entlasten.",
    },
  },

  /* =====================================================
     9) NEXT STEPS (überarbeitet)
  ===================================================== */
  next_steps: {
    interventions: {
      coaching_primary: [
    ...
    // by_scale bleibt bei dir wie gehabt; wenn du willst, konsolidiere ich das als eigenes Objekt
    // damit der Block hier nicht noch einmal 300 Zeilen sprengt.
    by_scale: {
      masking: [
...
export const PROFILE_DESCRIPTIONS = {
  adhd: {
    ...
    very_low: {
      ...
      description: "ADHS-nahe Muster stehen in Ihren Antworten nicht im Vordergrund.",
    },
  },
  ...
  autism: {
    ...
    low: {
      ...
      description: "Einzelne autismus-nahe Aspekte sind vorhanden, aber ohne klare Dominanz.",
    },
    very_low: {
      title: "Autismus-nahe Merkmale nicht dominant",
      description: "Autismus-nahe Muster stehen in Ihren Antworten nicht im Vordergrund.",
    },
  },
  ...
  audhd: {
    ...
    low: {
      ...
      description: "Eine Überlappung ist erkennbar, aber ohne klare Dominanz.",
    },
    very_low: {
      title: "Kein AuDHD-Muster im Vordergrund",
      description: "Eine deutliche gleichzeitige Dominanz beider Richtungen zeigt sich nicht.",
    },
  },
  ...
  high_masking: {
    ...
    medium: {
      ...
      description: "Anpassung ist spürbar. Kosten können in Stressphasen stark steigen.",
    },
    low: {
      title: "Moderate Anpassungsleistung",
      description: "Anpassung ist vorhanden, aber nicht dominierend.",
    },
  },
  ...
  stress: {
    ...
    medium: {
      ...
      description: "Belastung ist erkennbar. Kleine Entlastungen können große Wirkung haben.",
    },
    low: {
      title: "Moderate Belastung",
      description: "Belastung tritt situationsabhängig auf.",
    },
  },
  ...
  traits: {
    ...
    high: {
      ...
      description: "Merkmale sind vorhanden, aber ohne klare Dominanz.",
    },
    medium: {
      title: "Leichte Tendenzen",
      description: "Einige Bereiche sind moderat erhöht.",
    },
    low: {
      title: "Sehr leichte Merkmale",
      description: "Nur geringe Abweichungen innerhalb dieser Skalen.",
    },
  },
  ...
  single_dominant: {
    very_high: {
      title: (scale) =>
        `Schwerpunkt: ${PROFILE_TEXTS.dominant_scale.names[scale] || "prägender Bereich"}`,
      description: (scale, score) => {
        const name = PROFILE_TEXTS.dominant_scale.names[scale] || "dieser Bereich";
        const base =
          PROFILE_TEXTS.dominant_scale.descriptions[scale] ||
          "Dieser Bereich prägt Ihr Muster deutlich.";
